...
Copy-Item "$diretorio_trabalho/js/locations/locations-data-update.js" -Destination "$diretorio_trabalho/bk/$DateStr/locations-data-update.js" -Recurse -force
...
Copy-Item "$diretorio_trabalho/js/locations/locations-data-update.js" -Destination "$diretorio_site/js/locations/locations-data-update.js" -Recurse -force
...
Copy-Item "$diretorio_trabalho/js/locations/locations-data-update.js" -Destination "$diretorio_site/js/locations/old/$DateStr/locations-data-update.js" -Recurse -force
